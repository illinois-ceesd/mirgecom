...
# NB: Since 05/2025, this script is almost identical to scripts/run-gpus-generic.sh,
#     except for the missing CUDA_VISIBLE_DEVICES export, which does not
#     work anymore on porter since it only has one GPU.
