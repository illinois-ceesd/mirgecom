...
The Navier-Stokes conservation equations can be recast in a more compact form:
...
Inviscid fluxes and utility documentation are found in :mod:`mirgecom.inviscid`, and for
the Euler operator for the RHS in :mod:`mirgecom.euler`.
...
Transport models provided by |mirgecom| are documented in :mod:`mirgecom.transport`.
