...
mixture species $N_s$ on unstructured meshes and
...
$N_s$ components with $1 \le \alpha \le N_s$. Unless otherwise noted, repeated indices imply
summation.
