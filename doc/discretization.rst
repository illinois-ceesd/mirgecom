...
This section breaks out explicit component versions of the second order terms on the RHS to
...
The viscous fluxes $\b{F}^{V}$ are proportional to gradients of the fluid state
variables, introducing second order terms on the RHS of the conservation equations. These second
